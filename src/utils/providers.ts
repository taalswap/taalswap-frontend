...
const auroraHttpProvider = new ethers.providers.StaticJsonRpcProvider(AURORA_RPC_URL)
...
export const getSimpleRpcProvider = () => {
  ...
  if ( getChainId() === ChainId.AURORAMAIN || getChainId() === ChainId.AURORATEST ) return auroraHttpProvider
