...
const AURORA_RPC_URL = getSelectedNodeUrl(process.env.REACT_APP_AURORA_ID)
...
const auroraHttpProvider = new Web3.providers.HttpProvider(AURORA_RPC_URL, { timeout: 10000 } as HttpProviderOptions)
...
const web3AURORANoAccount = new Web3(auroraHttpProvider)
...
const getWeb3NoAccount = () => {
  ...
  if (getChainId() === ChainId.AURORAMAIN || getChainId() === ChainId.AURORATEST)
