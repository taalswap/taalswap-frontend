...
const NumericalInputLine = styled(NumericalInput)`
  background-color: ${(props) =>
    props.disabled ? ({ theme }) => theme.colors.backgroundDisabled : ({ theme }) => theme.colors.background};
  @media screen and (max-width: 500px) {
    max-width: 160px;
    background-color: ${({ theme }) => theme.colors.tertiary};
          ...
          {!hideInput && (
            <>
              <NumericalInputLine
                ...
                disabled={id === 'swap-currency-output' && chainId !== crossChain}
                style={{}}
              />
          ...
          <CurrencySelect
            ...
            onClick={() => {
              if (!disableCurrencySelect) {
                window.localStorage.setItem('xSwapCurrency', id === 'swap-currency-input' ? 'input' : 'output')
                setModalOpen(true)
              }
            }}
          >
