    ...
    <ReCard>
      <ReCardBody>
        ...
        <RowBetween style={{ padding: '.25rem 0' }}>
          ...
          <Text fontSize="14px">{realizedLPFee ? `${realizedLPFee.toSignificant(4)} ${FEE}` : '-'}</Text>
        </RowBetween>
      </ReCardBody>
    </ReCard>
  )
...
export function AdvancedXSwapDetails({ trade, tradeX }: AdvancedXSwapDetailsProps) {
            ...
            {showRoute && (
              <>
                ...
                <AutoColumnSub>
                  ...
                  {trade.route.input.symbol !== 'TAL' && trade.route.input.symbol !== 'KTAL' && (
                    <SwapRoute trade={trade} />
                  )}
                  {tradeX !== undefined &&
                    tradeX?.route.output.symbol !== 'TAL' &&
                    tradeX?.route.output.symbol !== 'KTAL' && <SwapRoute trade={tradeX} />}
                </AutoColumnSub>
              </>
            )}
          </>
