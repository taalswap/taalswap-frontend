...
import { Skeleton, Text, useTooltip, HelpIcon, Flex, Box, useModal, useMatchBreakpoints } from 'taalswap-uikit'
...
const EarningsCell: React.FC<EarningsCellProps> = ({ pool, account, userDataLoaded }) => {
  ...
  const labelText = isAutoVault ? t('Recent TAL profit') : t('%asset% Earned', { asset: earningToken.symbol })
