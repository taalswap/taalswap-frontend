...
import { usePairContract } from '../../hooks/useContract2'
                      ...
                      {chainId && (oneCurrencyIsWETH || oneCurrencyIsETH) ? (
                        <RowBetween style={{ justifyContent: 'flex-end' }}>
                          {oneCurrencyIsETH ? (
                            ...
                            <StyledInternalLink
                              to={`/remove/${
                                currencyA && currencyEquals(currencyA, WETH[chainId]) ? ethStr : currencyIdA
                              }/${currencyB && currencyEquals(currencyB, WETH[chainId]) ? ethStr : currencyIdB}`}
                            >
                              {t(receivedEthStr)}
                            </StyledInternalLink>
                          ) : null}
