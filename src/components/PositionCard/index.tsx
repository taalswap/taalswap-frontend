          ...
          <AutoColumn gap="8px">
            <FixedHeightRow>
              <RowFixed>
                ...
                <Text>
                  {t('Pooled %symbol%', {
                    symbol: currency0.symbol !== undefined ? currency0.symbol : '',
                  })}
                  :
                </Text>
              </RowFixed>
            ...
            <FixedHeightRow>
              <RowFixed>
                ...
                <Text>
                  {t('Pooled %symbol%', {
                    symbol: currency1.symbol !== undefined ? currency1.symbol : '',
                  })}
                  :
                </Text>
              </RowFixed>
            ...
            <RowBetween marginTop="10px">
              {removeOnly && (
                <Button
                  as={Link}
                  to={`/add/${chainId}/${currencyId(currency0)}/${currencyId(currency1)}`}
                  style={{ width: '100%' }}
                >
                  Add
                </Button>
