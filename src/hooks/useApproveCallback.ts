...
import { Trade, TokenAmount, CurrencyAmount, ETHER, KLAYTN, BINANCE, POLYGON, AURORA, ChainId } from 'taalswap-sdk'
...
import { useTokenContract } from './useContract2'
...
export function useApproveCallback(
  ...
  const approvalState: ApprovalState = useMemo(() => {
    ...
    if (amountToApprove.currency === ETHER || amountToApprove.currency === KLAYTN || amountToApprove.currency === BINANCE || amountToApprove.currency === POLYGON || amountToApprove.currency === AURORA) return ApprovalState.APPROVED
